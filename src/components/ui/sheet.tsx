  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === 'top' &&
          'inset-x-0 top-0 rounded-b-2xl data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top max-h-[85vh] overflow-y-auto',
        side === 'left' &&
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      'sticky top-0 bg-white z-10 flex items-center justify-between px-4 py-3 border-b',
      className
    )}
    {...props}
  />
